...
public class ModelUtils {
	...
	public static void saveModel(OmegaDiT_T5 model, String outpath) {
	...
	public static void loadModel(OmegaDiT_T5 model, String inputPath) {
	...
	public static void loadModel(JiT_Sprint model, String inputPath) {
        try (RandomAccessFile File = new RandomAccessFile(inputPath, "r")) {
            System.out.println("start load model...");
            model.loadModel(File);
            System.out.println("model load success...");
	...
	public static void saveModel(JiT_Sprint2 model, String outpath) {
        File file = new File(outpath);
        if (!file.exists()) {
            try {
                file.createNewFile();
	...
	public static void loadModel(JiT_Sprint2 model, String inputPath) {
        try (RandomAccessFile File = new RandomAccessFile(inputPath, "r")) {
            System.out.println("start load model...");
            model.loadModel(File);
            System.out.println("model load success...");
	...
	public static void saveModel(MMJiT_Sprint model, String outpath) {
        File file = new File(outpath);
        if (!file.exists()) {
            try {
                file.createNewFile();
	...
	public static void loadModel(MMJiT_Sprint model, String inputPath) {
        try (RandomAccessFile File = new RandomAccessFile(inputPath, "r")) {
            System.out.println("start load model...");
            model.loadModel(File);
            System.out.println("model load success...");
	...
	public static void saveModel(MMJiT_REPA model, String outpath) {
        File file = new File(outpath);
        if (!file.exists()) {
            try {
                file.createNewFile();
	...
	public static void loadModel(MMJiT_REPA model, String inputPath) {
        try (RandomAccessFile File = new RandomAccessFile(inputPath, "r")) {
            System.out.println("start load model...");
            model.loadModel(File);
            System.out.println("model load success...");
	...
	public static void saveModel(MMJiT model, String outpath) {
        File file = new File(outpath);
        if (!file.exists()) {
            try {
                file.createNewFile();
	...
	public static void loadModel(MMJiT model, String inputPath) {
        try (RandomAccessFile File = new RandomAccessFile(inputPath, "r")) {
            System.out.println("start load model...");
            model.loadModel(File);
            System.out.println("model load success...");
