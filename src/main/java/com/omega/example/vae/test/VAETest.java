...
public class VAETest {
    public static void loadWeight(Map<String, Object> weightMap, TinyVAE network, boolean showLayers) {
         ...
         */
        network.conv_mu.weight = ModeLoaderlUtils.loadData(network.conv_mu.weight, weightMap, 4, "fc_mu.weight");
        ModeLoaderlUtils.loadData(network.conv_mu.bias, weightMap, "fc_mu.bias");
        /**
         * conv_var

         */
        network.conv_var.weight = ModeLoaderlUtils.loadData(network.conv_var.weight, weightMap, 4, "fc_var.weight");
        ModeLoaderlUtils.loadData(network.conv_var.bias, weightMap, "fc_var.bias");
        /**
         * decoder input
