 ...
 */
public class LTXVideo_VAE_Encoder extends Network {
    ...
    public LTXVideo_VAE_Encoder(LossType lossType, UpdaterType updater, int num_frames, int height, int width, int patch_size_t, int patch_size, int[] block_out_channels, int[] layers_per_block, boolean[] spatio_temporal_scaling) {
