...
import com.omega.engine.nn.layer.jit.JiTMainMoudue;
 ...
 */
public class JiT extends Network {
    ...
    public JiT(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int bottleneck_dim, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio,boolean learnSigma, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new JiTMainMoudue(inChannel, width, height, patchSize, bottleneck_dim, hiddenSize, headNum, depth, timeSteps, textEmbedDim, maxContextLen, mlpRatio, learnSigma, y_drop_prob, this);
