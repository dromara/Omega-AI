...
import com.omega.engine.nn.layer.dit.sprint.OmegaDiTMainMoudue_Self_Flow;
 ...
 */
public class OmegaDiT_Self_Flow extends Network {
    ...
    public OmegaDiTMainMoudue_Self_Flow main;
    ...
    public OmegaDiT_Self_Flow(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio, float path_drop_prob, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new OmegaDiTMainMoudue_Self_Flow(inChannel, width, height, patchSize, hiddenSize, headNum, depth, timeSteps, textEmbedDim, maxContextLen, mlpRatio, y_drop_prob, path_drop_prob, this);
    ...
    public Tensor forward_teacher(Tensor input, Tensor t, Tensor context, Tensor cos, Tensor sin) {
        /**
         * 设置输入数据
         */
        this.setInputData(input);
        this.main.forward_teacher(input, t, context, cos, sin);
        return this.main.z_img_x;
    }
