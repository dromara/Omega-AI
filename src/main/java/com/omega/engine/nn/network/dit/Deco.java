...
import com.omega.engine.nn.layer.dit.deco.PixNerDiTMainMoudue;
 ...
 */
public class Deco extends Network {
    ...
    public PixNerDiTMainMoudue main;
    ...
    public Deco(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int decoder_hidden_size, int headNum, int num_encoder_blocks, int num_decoder_blocks, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new PixNerDiTMainMoudue(inChannel, width, height, patchSize, hiddenSize, decoder_hidden_size, headNum, num_encoder_blocks, num_decoder_blocks, timeSteps, textEmbedDim, maxContextLen, mlpRatio, y_drop_prob, this);
