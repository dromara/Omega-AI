...
public class MMJiT_Sprint extends Network {
    ...
    public Tensor forward_with_path_drop_cfg(Tensor input, Tensor context, Tensor null_context, Tensor cos1d, Tensor sin1d, Tensor cos2d, Tensor sin2d, Tensor eps, float cfg_scale) {
        /**
         * 设置输入数据
         */
        if(input_null == null || input_null.number != input.number) {
