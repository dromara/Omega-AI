...
import com.omega.engine.nn.layer.dit.sprint.FluxDiTMainMoudue_Tread;
 ...
 */
public class FluxDiT_TREAD extends Network {
    ...
    public FluxDiTMainMoudue_Tread main;
    ...
    public FluxDiT_TREAD(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio, int z_dim, float token_drop_ratio, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new FluxDiTMainMoudue_Tread(inChannel, width, height, patchSize, hiddenSize, headNum, depth, timeSteps, textEmbedDim, maxContextLen, mlpRatio, z_dim, y_drop_prob, token_drop_ratio, this);
