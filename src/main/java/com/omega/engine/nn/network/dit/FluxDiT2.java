...
import com.omega.engine.nn.layer.dit.flux.FluxDDTMainMoudue;
 ...
 */
public class FluxDiT2 extends Network {
    ...
    public FluxDiT2(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int en_depth, int de_depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio,boolean learnSigma, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new FluxDDTMainMoudue(inChannel, width, height, patchSize, hiddenSize, headNum, en_depth, de_depth, timeSteps, textEmbedDim, maxContextLen, mlpRatio, learnSigma, y_drop_prob, this);
