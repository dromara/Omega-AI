 ...
 */
public class MMJiT_REPA extends Network {
    ...
    public MMJiTMainMoudue_REPA main;
    
    private Tensor input_null;
    private Tensor uncond_eps;
    
    public MMJiT_REPA(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int bottleneck_dim, int hiddenSize, int headNum, int z_dim, int txt_depth, int depth, int textEmbedDim, int maxContextLen, float y_drop_prob) {
    ...
    public void initLayers() {
        ...
        main = new MMJiTMainMoudue_REPA(inChannel, width, height, patchSize, bottleneck_dim, hiddenSize, headNum, z_dim, txt_depth, depth, textEmbedDim, maxContextLen, y_drop_prob, this);
