...
import com.omega.engine.nn.layer.opensora.dit.moudles.OpenSoraDiTMoudue;
 ...
 */
public class OpenSoraDIT extends Network {
    ...
    public OpenSoraDiTMoudue main;
    
    private SmoothL1Kernel smoothL1Kernel;
    
    public OpenSoraDIT(LossType lossType, UpdaterType updater, int inChannel, int numFrames, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int maxContextLen, int textEmbedDim, int mlpRatio, boolean learnSigma) {
    ...
    public void initLayers() {
        ...
        main = new OpenSoraDiTMoudue(inChannel, numFrames, width, height, patchSize, hiddenSize, headNum, depth, timeSteps, maxContextLen, textEmbedDim, mlpRatio, learnSigma, 0.0f, this);
