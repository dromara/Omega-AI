...
import com.omega.engine.nn.layer.dit.flux.FluxDiTMainMoudue2;
 ...
 */
public class FluxDiT3 extends Network {
    ...
    public FluxDiTMainMoudue2 main;
    ...
    public FluxDiT3(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio,boolean learnSigma, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new FluxDiTMainMoudue2(inChannel, width, height, patchSize, hiddenSize, headNum, depth, timeSteps, textEmbedDim, maxContextLen, mlpRatio, learnSigma, y_drop_prob, this);
