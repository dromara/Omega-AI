...
import com.omega.engine.nn.layer.dit.video.OmegaVideoDiTMainI2V2;
 ...
 */
public class OmegaVideoI2V2 extends Network {
    ...
    public OmegaVideoDiTMainI2V2 main;
    ...
    public OmegaVideoI2V2(LossType lossType, UpdaterType updater, int inChannel, int num_frames, int height, int width, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, float token_drop_ratio, float path_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new OmegaVideoDiTMainI2V2(inChannel, num_frames, height, width, patchSize, hiddenSize, headNum, depth, timeSteps, token_drop_ratio, path_drop_prob, this);
    ...
    public Tensor forward(Tensor input, Tensor z_img, Tensor t, Tensor[] cos, Tensor[] sin) {
        /**
         * 设置输入数据
         */
        this.setInputData(input);
        this.main.forward(input, z_img, t, cos, sin);
        return this.main.getOutput();
    }
    
    public Tensor forward_with_path_drop_cfg(Tensor input, Tensor z_img, Tensor t, Tensor[] cos, Tensor[] sin, Tensor eps, float cfg_scale) {
        /**
         * 设置输入数据
         */
        ...
        if(cfg_scale != 1.0f){
            ...
            this.main.forward(input_null, z_img, t, cos, sin);
