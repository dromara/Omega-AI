...
import com.omega.engine.nn.layer.dit.sprint.FluxDiTMainMoudue_Sprint_Reg;
 ...
 */
public class FluxDiT_SPRINT_REG extends Network {
    ...
    public FluxDiTMainMoudue_Sprint_Reg main;
    ...
    public FluxDiT_SPRINT_REG(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio, int z_dim, float token_drop_ratio, float path_drop_prob, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new FluxDiTMainMoudue_Sprint_Reg(inChannel, width, height, patchSize, hiddenSize, headNum, depth, timeSteps, textEmbedDim, maxContextLen, mlpRatio, z_dim, y_drop_prob, token_drop_ratio, path_drop_prob, this);
    ...
    public Tensor forward(Tensor input, Tensor t, Tensor context, Tensor cls_token, Tensor cos, Tensor sin) {
        /**
         * 设置输入数据
         */
        this.setInputData(input);
        this.main.forward(input, t, context, cls_token, cos, sin);
        return this.main.getOutput();
    }
    
    public Tensor forward_with_cfg(Tensor input, Tensor t, Tensor context, Tensor cls_token, Tensor cos, Tensor sin, Tensor eps, float cfg_scale) {
        /**
         * 设置输入数据
         */
        ...
        this.main.forward(input_null, t, context, cls_token, cos, sin);
    ...
    public Tensor forward_with_path_drop_cfg(Tensor input, Tensor t, Tensor context, Tensor null_context, Tensor cls_token, Tensor cos, Tensor sin, Tensor eps, float cfg_scale) {
        /**
         * 设置输入数据
         */
        ...
        this.main.forward(input_null, t, null_context, cls_token, cos, sin);
    ...
    public void back(Tensor lossDiff, Tensor cls_delta,Tensor cos, Tensor sin) {
        // TODO Auto-generated method stub
        //		lossDiff.showDMByNumber(0);
        initBack();
        /**
        ...
        this.setLossDiff(lossDiff);
        //		lossDiff.showDM("lossDiff");
        this.main.back(lossDiff, cls_delta, cos, sin);
        //		this.unet.diff.showDMByOffset(0, 100, "unet.diff");
    }
