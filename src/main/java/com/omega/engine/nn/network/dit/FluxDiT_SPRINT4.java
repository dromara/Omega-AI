...
import com.omega.engine.nn.layer.dit.sprint.FluxDiTMainMoudue_Sprint4;
 ...
 */
public class FluxDiT_SPRINT4 extends Network {
    ...
    public FluxDiTMainMoudue_Sprint4 main;
    ...
    public FluxDiT_SPRINT4(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio, int z_dim, float token_drop_ratio, float path_drop_prob, float y_drop_prob) {
...
//        this.weight_decay = 0.1f;
    ...
    public void initLayers() {
        ...
        main = new FluxDiTMainMoudue_Sprint4(inChannel, width, height, patchSize, hiddenSize, headNum, depth, timeSteps, textEmbedDim, maxContextLen, mlpRatio, z_dim, y_drop_prob, token_drop_ratio, path_drop_prob, this);
