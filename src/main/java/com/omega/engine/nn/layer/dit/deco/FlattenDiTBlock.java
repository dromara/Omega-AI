 ...
 */
public class FlattenDiTBlock extends Layer {
    ...
    public MMDiTAttentionLayer attn;
    ...
    public FlattenDiTBlock(int embedDim, int cEmbedDim, int time, int mlpHiddenDim, int headNum, int maxContext, boolean bias, boolean qkNorm, Network network) {
    ...
    public void initLayers() {
        ...
        this.attn = new MMDiTAttentionLayer(embedDim, headNum, time, maxContext, bias, qkNorm, network);
    ...
    public void output(Tensor tc, Tensor context, Tensor pos) {
    	...
    	attn.forward(attnInput, context, pos);
//    	attn.getOutput().showDM("attn");
    ...
    public void diff(Tensor dtc, Tensor dcontext,Tensor pos) {
//    	delta.showDM("x3");
    	/**
...
//    	attn.diff.showDM("attn.diff");
     ...
     * @param text
     */
    public void forward(Tensor input,Tensor tc,Tensor context,Tensor pos) {
        // TODO Auto-generated method stub
        /**
         * 设置输入
         */
    ...
    public void back(Tensor delta,Tensor dtc,Tensor dcontext,Tensor pos) {
        // TODO Auto-generated method stub
        this.initBack();
        /**
         * 设置梯度
    ...
    public static void loadWeight(Map<String, Object> weightMap, FlattenDiTBlock block, boolean showLayers) {
        if (showLayers) {
    ...
    public static void main(String[] args) {
        ...
        FlattenDiTBlock block = new FlattenDiTBlock(embedDim, embedDim, time, embedDim * 4, headNum, 77, true, false, tf);
