...
public class AttentionLayer extends Layer {
    ...
    public AttentionLayer(int embedDim, int headNum, int time, boolean bias, boolean qkNorm) {
        this.bias = bias;
        this.time = time;
    ...
    public AttentionLayer(int embedDim, int headNum, int time, boolean bias, boolean qkNorm, Network network) {
        this.bias = bias;
