 ...
 */
public class DiTCrossAttentionLayer extends Layer {
    ...
    public DiTCrossAttentionLayer(int embedDim, int kvDim, int headNum, int time, int kvTime, boolean bias) {
        this.bias = bias;
        this.time = time;
        this.kvTime = kvTime;
    ...
    public DiTCrossAttentionLayer(int embedDim, int kvDim, int headNum, int time, int kvTime, boolean bias, Network network) {
        this.bias = bias;
    ...
    public static void main(String[] args) {
        ...
        DiTCrossAttentionLayer mal = new DiTCrossAttentionLayer(embedDim, context_dim, headNum, time, context_time, false, tf);
    ...
    public static void loadWeight(Map<String, Object> weightMap, DiTCrossAttentionLayer network, boolean showLayers) {
        if (showLayers) {
