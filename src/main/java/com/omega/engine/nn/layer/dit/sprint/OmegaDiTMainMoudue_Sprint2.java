 ...
 */
public class OmegaDiTMainMoudue_Sprint2 extends Layer {
    ...
    public OmegaDiTMainMoudue_Sprint2(int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio, float y_drop_prob, float token_drop_ratio, float path_drop_prob, Network network) {
...
//		dh.showDMByOffsetRed(78 * 768, 768, "dh");
    ...
    public static void loadWeight(Map<String, Object> weightMap, OmegaDiTMainMoudue_Sprint2 block, boolean showLayers) {
        if (showLayers) {
