 ...
 */
public class SDVAEAttentionLayer extends Layer {
    public GNLayer gn;
    public SDVAESelfAttentionLayer attn;
    ...
    public SDVAEAttentionLayer(int embedDim, int headNum, int height, int width, int groups, boolean bias, Network network) {
        this.bias = bias;
        this.groups = groups;
    ...
    public static void main(String[] args) {
        try {
            ...
            network.CUDNN = true;
            SDVAEAttentionLayer attn = new SDVAEAttentionLayer(channel, headNum, height, width, groups, false, network);
    ...
    public void initLayers() {
        ...
        attn = new SDVAESelfAttentionLayer(embedDim, headNum, time, bias, network);
    }
