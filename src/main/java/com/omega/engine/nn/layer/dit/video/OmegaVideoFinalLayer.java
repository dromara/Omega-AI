...
/**
 * OmegaVideoFinalLayer
 *
 * @author Administrator
 */
public class OmegaVideoFinalLayer extends Layer {
    ...
    public OmegaVideoFinalLayer(int patch_size, int hidden_size,int out_channels, int time, boolean bias) {
        this.hidden_size = hidden_size;
        this.bias = bias;
        this.oChannel = 1;
        this.oHeight = 1;
        this.oWidth = patch_size * patch_size * patch_size * out_channels;
        this.time = time;
        this.initLayers();
    }

    public OmegaVideoFinalLayer(int patch_size, int hidden_size,int out_channels, int time, boolean bias, boolean normParams, Network network) {
...
//    	finalLinear.diff.showDM("l1");
    ...
    public static void loadWeight(Map<String, Object> weightMap, OmegaVideoFinalLayer block, boolean showLayers) {
        if (showLayers) {
    ...
    public static void main(String[] args) {
        ...
        OmegaVideoFinalLayer finalLayer = new OmegaVideoFinalLayer(patch_size, embedDim, outChannel, time, true, true, tf);
