 ...
 */
public class FluxDiTMainMoudue_Sprint extends Layer {
...
//			getRandomIds(idsKeep);
    ...
    public static void loadWeight(Map<String, Object> weightMap, FluxDiTMainMoudue_Sprint block, boolean showLayers) {
        if (showLayers) {
