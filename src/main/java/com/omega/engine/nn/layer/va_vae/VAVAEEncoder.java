 ...
 */
public class VAVAEEncoder extends Layer {
    ...
    public VAVAEEncoder(int channel, int oChannel, int height, int width, int num_res_blocks, int groups, int[] ch_mult, int ch, Network network) {
    ...
    public VAVAEEncoder(int channel, int oChannel, int height, int width, int num_res_blocks, int groups, int[] ch_mult, int ch, boolean hasAttn, Network network) {
        this.network = network;
        this.channel = channel;
        this.oChannel = oChannel;
        this.height = height;
