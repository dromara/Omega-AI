 ...
 */
public class JiTMainMoudue extends Layer {
    ...
    public JiTMainMoudue(int inChannel, int width, int height, int patchSize, int bottleneck_dim, int hiddenSize, int headNum, int depth, int timeSteps, int textEmbedDim, int maxContextLen, int mlpRatio, boolean learnSigma, float y_drop_prob, Network network) {
...
//        }
    ...
    public static void loadWeight(Map<String, Object> weightMap, JiTMainMoudue block, boolean showLayers) {
        if (showLayers) {
