...
//        temp.showDMByOffsetRed(0, 10, "temp");
    ...
    public void forward(Tensor input, Tensor context, Tensor c, Tensor cos, Tensor sin) {
        // TODO Auto-generated method stub
        /**
         * 参数初始化
         */
    ...
    public void back(Tensor delta, Tensor cx_delta, Tensor cd, Tensor cos, Tensor sin) {
        // TODO Auto-generated method stub
        this.initBack();
        /**
         * 设置梯度
