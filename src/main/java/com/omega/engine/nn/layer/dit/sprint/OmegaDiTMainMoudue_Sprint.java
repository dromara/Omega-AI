 ...
 */
public class OmegaDiTMainMoudue_Sprint extends Layer {
...
//		dh.showDMByOffsetRed(78 * 768, 768, "dh");
    ...
    public static void loadWeight(Map<String, Object> weightMap, OmegaDiTMainMoudue_Sprint block, boolean showLayers) {
        if (showLayers) {
