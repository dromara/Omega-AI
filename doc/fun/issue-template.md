...
在线提问链接：[Gitee issue](https://gitee.com/dromara/omega-ai/issues)、[GitHub issue](https://github.com/dromara/omega-ai/issues)

> [!TIP| label:请在新建 issue 时，尽量复制模板格式进行提交] 
> 1. 提交之前率先参考 <a href="#/more/common-questions" target="_blank">Omega-AI 常见问题解答</a> 以及善用 Gitee issues 搜索功能，查阅问题是否已有答案，已存在的 issue 就不要再重复提交了。
