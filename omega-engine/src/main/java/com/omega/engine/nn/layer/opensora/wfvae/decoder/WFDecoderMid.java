 ...
 */
public class WFDecoderMid extends Layer {
    ...
    public WFDecoderMid(int channel, int oChannel, int depth, int height, int width, Network network) {
    ...
    public void initLayers() {
    	...
    	block1 = new WFResnet3DBlock(channel, channel, depth, height, width, network);
    	
    	attn = new WFAttentionBlock3D(channel, depth, height, width, false, false, network);

    	block2 = new WFResnet3DBlock(channel, oChannel, depth, height, width, network);
...
//        block.diff.showDM();
    ...
    public static void loadWeight(Map<String, Object> weightMap, WFDecoderMid block, boolean showLayers) {
        if (showLayers) {
