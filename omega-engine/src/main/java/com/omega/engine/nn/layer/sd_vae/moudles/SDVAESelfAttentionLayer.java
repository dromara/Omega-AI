 ...
 */
public class SDVAESelfAttentionLayer extends Layer {
    ...
    public SDVAESelfAttentionLayer(int embedDim, int headNum, int time, boolean bias) {
        this.bias = bias;
        this.time = time;
    ...
    public SDVAESelfAttentionLayer(int embedDim, int headNum, int time, boolean bias, Network network) {
        this.bias = bias;
    ...
    public static void main(String[] args) {
        ...
        SDVAESelfAttentionLayer mal = new SDVAESelfAttentionLayer(embedDim, headNum, time, false, tf);
        for (int i = 0; i < 10; i++) {
            mal.forward(input);
