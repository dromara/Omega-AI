 ...
 */
public class ASRPoswiseFeedForwardLinearLayer extends Layer {
    ...
    public ASRPoswiseFeedForwardLinearLayer(int embedDim, int nChannel, boolean bias) {
    ...
    public ASRPoswiseFeedForwardLinearLayer(int embedDim, int nChannel, boolean bias, Network network) {
