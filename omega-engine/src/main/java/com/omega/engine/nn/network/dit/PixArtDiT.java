...
import com.omega.engine.nn.layer.dit.PixArtMoudue;
 ...
 */
public class PixArtDiT extends Network {
    ...
    public PixArtMoudue main;
    
    public PixArtDiT(LossType lossType, UpdaterType updater, int inChannel, int width, int height, int patchSize, int hiddenSize, int headNum, int depth, int timeSteps, int maxContextLen, int textEmbedDim, int mlpRatio,boolean learnSigma, float y_drop_prob) {
    ...
    public void initLayers() {
        ...
        main = new PixArtMoudue(inChannel, width, height, patchSize, hiddenSize, headNum, depth, timeSteps, maxContextLen, textEmbedDim, mlpRatio, learnSigma, y_drop_prob, this);
