 ...
 */
public class DCAEDecoderStage extends Layer {
	
	private int num_blocks = 2;
    private int group = 32;
    private DCAEResidualUpsampleBlock up;
    private List<DCAEResidual> resList; 
    
    public DCAEDecoderStage(int channel, int oChannel, int height, int width, int group, int num_blocks, Network network) {
    ...
    public void initLayers(int oChannel) {
    	...
    	up = new DCAEResidualUpsampleBlock(channel, oChannel, height, width, group, network);
