...
public class GPTTest {
    ...
    public static void ch_chat_gpt2() {
        try {
            ...
            while (true) {
                ...
                //				input.showDM();
                Tensor positions = CNChatTokenizer.getPositions(1, input.getShape()[0]);
                //				positions.showDM();
                ...
                for (int t = 0; t < max_len; t++) {
                    ...
                    CNChatTokenizer.getPositions(1, input.getShape()[0], positions);
    ...
    public static String genTxt(Tensor input, Tensor output, Tensor softmaxOut, NanoGPT network, CNTokenizer trainData, int maxLength, Tensor positions) {
        ...
        //		output.syncHost();
        softmaxOut = Tensor.createTensor(softmaxOut, input.getShape()[0], input.getShape()[1], input.getShape()[2], input.getShape()[3], true);
