...
public class LVMPreTrainDataset {
    ...
    public void loadData(Tensor input, Tensor label, Tensor imageInput, Tensor indice) {
        try {
            ...
            if (tmpInput == null) {
                tmpInput = new float[input.getDataLength()];
                tmpLabel = new float[label.getDataLength()];
                tmpImageInput = new float[imageInput.getDataLength()];
                tmpIndice = new float[indice.getDataLength()];
            }
            if (cf != null) {
