...
public class CNWikiTokenizer4 extends BaseTokenizer {
    public int number = 0;
    ...
    public CNWikiTokenizer4(String dataPath, int max_len, int batchSize, int number, SentencePieceTokenizer tokenizer) {
    ...
    public CNWikiTokenizer4(String dataPath, int max_len, int batchSize, SentencePieceTokenizer tokenizer) {
        this.dataPath = dataPath;
        this.max_len = max_len;
        this.batchSize = batchSize;
        this.tokenizer = tokenizer;
