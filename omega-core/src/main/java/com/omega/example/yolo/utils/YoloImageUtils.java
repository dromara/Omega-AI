...
public class YoloImageUtils {
        ...
        try {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                for (int i = 0; i < files.length; i++) {
                    ...
                    System.arraycopy(data, 0, set.input.getData(), i * channel * height * width, channel * height * width);
                }
        ...
        try {
            ...
            if (file.exists()) {
                if (normalization) {
                    ...
                    System.arraycopy(data, 0, out.getData(), idx * out.getShape()[1] * out.getShape()[2] * out.getShape()[3], out.getShape()[1] * out.getShape()[2] * out.getShape()[3]);
                } else {
    ...
    public static void loadImgDataToGrayTensor(String filePath, Tensor out, int idx) {
        try {
            ...
            if (file.exists()) {
                ...
                System.arraycopy(once, 0, out.getData(), idx * out.getShape()[1] * out.getShape()[2] * out.getShape()[3], out.getShape()[1] * out.getShape()[2] * out.getShape()[3]);
            }
        } catch (Exception e) {
            // TODO: handle exception
            e.printStackTrace();
    ...
    public static void loadImgDataResize(String filePath, Tensor out, int idx) {
        try {
            float[] sized = ImageLoader.resized(filePath, out.getShape()[2], out.getShape()[3]);
            System.arraycopy(sized, 0, out.getData(), idx * out.getShape()[1] * out.getShape()[2] * out.getShape()[3], out.getShape()[1] * out.getShape()[2] * out.getShape()[3]);
        } catch (Exception e) {
            // TODO: handle exception
            e.printStackTrace();
        }
