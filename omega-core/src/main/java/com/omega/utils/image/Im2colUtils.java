...
import com.omega.common.utils.kernal.KernalTo2d;
import com.omega.common.utils.kernal.KernalToVector;
import com.omega.common.utils.kernal.KernalToVector2;
...
public class Im2colUtils {
     ...
     * @return
     */
    public static void kernalToVector(float[][][][] x, float[] y, boolean isT) {
        int N = x.length;
        int C = x[0].length;
        int H = x[0][0].length;
        int W = x[0][0][0].length;
     ...
     * @return
     */
    public static void kernalToVector2(float[][][][] x, float[] y, boolean T) {
        int N = x.length;
        KernalToVector2 job = new KernalToVector2(x, y, T, 0, N - 1);
        ForkJobEngine.run(job);
    }
