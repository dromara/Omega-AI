...
public class DiTPatchEmbeddingLayer extends Layer {
    ...
    public void initLayers(int inChannel, int height, int width, int patchSize, boolean bias) {
        ...
        this.patchEmbedding.weight.setData(RandomUtils.xavierUniform(this.patchEmbedding.weight.getDataLength(), inChannel * patchSize * patchSize, embedDim * patchSize * patchSize, 1));
    ...
    public void output() {
        ...
        Tensor or = getPatchEmbedding().getOutput().view(this.number, getPatchEmbedding().getOutput().getShape()[1], 1, getPatchEmbedding().getOutput().getShape()[2] * getPatchEmbedding().getOutput().getShape()[3]);
