...
public class DiffusionUNetCond extends Network {
    ...
    public void initLayers() {
        ...
        unet = new UNetCond(inChannel, inChannel, height, width, downChannels, midChannels, downSamples, attns, timeSteps, tEmbDim, numDowns, numMids, numUps, groups, headNum, convOutChannels, textEmbedDim, maxContextLen, hasCond, this);
