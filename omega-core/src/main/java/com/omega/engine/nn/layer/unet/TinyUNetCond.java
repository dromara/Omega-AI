...
public class TinyUNetCond extends Layer {
    ...
    public TinyUNetCond(int channel, int height, int width, int[] downChannels, int[] midChannels, int timeSteps, int tEmbDim, int groups, int headNum, int textEmbedDim, int maxContextLen, Network network) {
