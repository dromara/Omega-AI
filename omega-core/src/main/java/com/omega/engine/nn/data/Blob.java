...
public class Blob {
    ...
    public Blob(int number, int channel, int height, int width, float[][] data) {
        this.number = number;
        this.channel = channel;
        this.height = height;
        this.width = width;
    ...
    public Blob(int number, int channel, int height, int width, float[][][][] maxtir) {
        this.number = number;
        this.channel = channel;
        this.height = height;
        this.width = width;
