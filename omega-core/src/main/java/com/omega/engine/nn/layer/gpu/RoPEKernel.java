...
//    	System.err.println("emb:"+JsonUtils.toJson(emb));
    ...
    public void forward(Tensor cos, Tensor sin, Tensor input, Tensor output) {
        try {
            int nrow = input.getShape()[0] * input.getShape()[1];
            int ncol = input.getShape()[2] * input.getShape()[3];
            /**
             ...
             */
            forwardParameters = Pointer.to(Pointer.to(input.getGpuData()), Pointer.to(output.getGpuData()), Pointer.to(cos.getGpuData()), Pointer.to(sin.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{input.getShape()[1]}), Pointer.to(new int[]{input.getShape()[3]}));
    ...
    public void forward2d(Tensor cos, Tensor sin, Tensor input, Tensor output,int T,int HN,int HS) {
        try {
             ...
             */
            forwardParameters = Pointer.to(Pointer.to(input.getGpuData()), Pointer.to(output.getGpuData()), Pointer.to(cos.getGpuData()), Pointer.to(sin.getGpuData()), Pointer.to(new int[]{input.getDataLength()}), Pointer.to(new int[]{T}), Pointer.to(new int[]{HN}), Pointer.to(new int[]{HS}));

            checkCUDA(cuLaunchKernel(forward_2d_function, this.CAFFE_GET_BLOCKS(input.getDataLength() /2), 1, 1,      // Grid dimension
    ...
    public void backward2d(Tensor cos, Tensor sin, Tensor delta, Tensor diff,int T,int HN,int HS) {
        try {
             ...
             */
        	backwardParameters = Pointer.to(Pointer.to(delta.getGpuData()), Pointer.to(diff.getGpuData()), Pointer.to(cos.getGpuData()), Pointer.to(sin.getGpuData()), Pointer.to(new int[]{delta.getDataLength()}), Pointer.to(new int[]{T}), Pointer.to(new int[]{HN}), Pointer.to(new int[]{HS}));

            checkCUDA(cuLaunchKernel(backward_2d_function, this.CAFFE_GET_BLOCKS(delta.getDataLength() /2), 1, 1,      // Grid dimension
            		CAFFE_CUDA_NUM_THREADS, 1, 1,      // Block dimension
                    0, null,               // Shared memory size and stream
    ...
    public void forward(Tensor cos, Tensor sin, Tensor q, Tensor k, Tensor qo, Tensor ko) {
        try {
            int nrow = q.getShape()[0] * q.getShape()[1];
            int ncol = q.getShape()[2] * q.getShape()[3];
            /**
             * const float* q,const float* k, float* qo, float* ko,float* c_cos,float* c_sin, int ncols, int T,int headSize

             */
            forwardParameters = Pointer.to(Pointer.to(q.getGpuData()), Pointer.to(k.getGpuData()), Pointer.to(qo.getGpuData()), Pointer.to(ko.getGpuData()), Pointer.to(cos.getGpuData()), Pointer.to(sin.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{q.getShape()[1]}), Pointer.to(new int[]{q.getShape()[3]}));
            int[] block_dims = new int[]{1, 256, 1};
            int num_blocks_x = (ncol + 2 * 256 - 1) / (2 * 256);
            int[] block_nums = new int[]{nrow, num_blocks_x, 1};
    ...
    public void forward32(Tensor input, Tensor output) {
        try {
             ...
             */
            forwardParameters = Pointer.to(Pointer.to(input.getGpuData()), Pointer.to(output.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{input.getShape()[1]}), Pointer.to(new float[]{theta_scale}));
    ...
    public void forwardAll32(Tensor q, Tensor k, Tensor qo, Tensor ko) {
        try {
             ...
             */
            forwardParameters = Pointer.to(Pointer.to(q.getGpuData()), Pointer.to(k.getGpuData()), Pointer.to(qo.getGpuData()), Pointer.to(ko.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{q.getShape()[1]}), Pointer.to(new float[]{theta_scale}));
            int[] block_dims = new int[]{1, 2 * 256, 1};
            int num_blocks_x = (ncol + 2 * 256 - 1) / (2 * 256);
            int[] block_nums = new int[]{nrow, num_blocks_x, 1};
    ...
    public void backward(Tensor cos, Tensor sin, Tensor delta, Tensor diff) {
        try {
            int nrow = delta.getShape()[0] * delta.getShape()[1];
            int ncol = delta.getShape()[2] * delta.getShape()[3];
            /**
             * const float* x, float* dst,float* c_cos,float* c_sin, int ncols
             * const float* x, float* dst,float* c_cos,float* c_sin, int ncols, int T,int headSize
             */
            backwardParameters = Pointer.to(Pointer.to(delta.getGpuData()), Pointer.to(diff.getGpuData()), Pointer.to(cos.getGpuData()), Pointer.to(sin.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{delta.getShape()[1]}), Pointer.to(new int[]{delta.getShape()[3]}));
            int[] block_dims = new int[]{1, 256, 1};
            int num_blocks_x = (ncol + 2 * 256 - 1) / (2 * 256);
            int[] block_nums = new int[]{nrow, num_blocks_x, 1};
    ...
    public void backward(Tensor cos, Tensor sin, Tensor deltaQ, Tensor deltaK, Tensor diffQ, Tensor diffK) {
        try {
            int nrow = deltaQ.getShape()[0] * deltaQ.getShape()[1];
            int ncol = deltaQ.getShape()[2] * deltaQ.getShape()[3];
            /**
             * float* deltaQ,float* deltaK, float* diffQ, float* diffK,float* c_cos,float* c_sin, int ncols, int T,int headSize
             */
            backwardParameters = Pointer.to(Pointer.to(deltaQ.getGpuData()), Pointer.to(deltaK.getGpuData()), Pointer.to(diffQ.getGpuData()), Pointer.to(diffK.getGpuData()), Pointer.to(cos.getGpuData()), Pointer.to(sin.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{deltaQ.getShape()[1]}), Pointer.to(new int[]{deltaQ.getShape()[3]}));
            int[] block_dims = new int[]{1, 256, 1};
            int num_blocks_x = (ncol + 2 * 256 - 1) / (2 * 256);
            int[] block_nums = new int[]{nrow, num_blocks_x, 1};
    ...
    public void backward32(Tensor delta, Tensor diff) {
        try {
             ...
             */
            backwardParameters = Pointer.to(Pointer.to(delta.getGpuData()), Pointer.to(diff.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{delta.getShape()[1]}), Pointer.to(new float[]{theta_scale}));
            int[] block_dims = new int[]{1, 2 * 256, 1};
            int num_blocks_x = (ncol + 2 * 256 - 1) / (2 * 256);
            int[] block_nums = new int[]{nrow, num_blocks_x, 1};
    ...
    public void backwardAll32(Tensor deltaQ, Tensor deltaK, Tensor diffQ, Tensor diffK) {
        try {
             ...
             */
            backwardParameters = Pointer.to(Pointer.to(deltaQ.getGpuData()), Pointer.to(deltaK.getGpuData()), Pointer.to(diffQ.getGpuData()), Pointer.to(diffK.getGpuData()), Pointer.to(new int[]{ncol}), Pointer.to(new int[]{deltaQ.getShape()[1]}), Pointer.to(new float[]{theta_scale}));
            int[] block_dims = new int[]{1, 2 * 256, 1};
            int num_blocks_x = (ncol + 2 * 256 - 1) / (2 * 256);
            int[] block_nums = new int[]{nrow, num_blocks_x, 1};
