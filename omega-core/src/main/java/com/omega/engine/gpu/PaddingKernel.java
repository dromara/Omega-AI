...
public class PaddingKernel extends CUDAKernel {
    ...
    public static void main(String args[]) {
        ...
        output.setData(MatrixUtils.order(output.getDataLength(), 1, 1));
        output.hostToDevice();
        output.showDM();
        ...
        output2.setData(MatrixUtils.order(output2.getDataLength(), 1, 1));
    ...
    public Tensor createOutput(Tensor x, int xd, int[] padding) {
        ...
        return new Tensor(x.getShape()[0], C * oDepth, oHeight, oWidth, true);
    }
    ...
    public Tensor createOutput2D(Tensor x, int[] padding) {
        ...
        int oHeight = H + padding[2] + padding[3];
        int oWidth = W + padding[0] + padding[1];
        return new Tensor(x.getShape()[0], C , oHeight, oWidth, true);
    }
    ...
    public void padding2d(Tensor x, Tensor y, int[] padding, float val) {
        try {
            ...
            int oHeight = H + padding[2] + padding[3];
            int oWidth = W + padding[0] + padding[1];
            if ( y.getShape()[2] != oHeight || y.getShape()[3] != oWidth) {
             ...
             */
            kernelParameters = Pointer.to(Pointer.to(new long[]{y.getDataLength()}), Pointer.to(x.getGpuData()), Pointer.to(new int[]{x.getShape()[0]}), Pointer.to(new int[]{C}), Pointer.to(new int[]{H}), Pointer.to(new int[]{W}), Pointer.to(new int[]{H * W}), Pointer.to(new int[]{oHeight}), Pointer.to(new int[]{oWidth}), Pointer.to(new int[]{oHeight * oWidth}), Pointer.to(new int[]{padding[2]}), Pointer.to(new int[]{padding[0]}), Pointer.to(new float[]{val}), Pointer.to(y.getGpuData()));
            cuLaunchKernel(function2d, this.CAFFE_GET_BLOCKS(y.getDataLength()), 1, 1,      // Grid dimension
    ...
    public void padding2dGrad(Tensor dy, Tensor dx, int[] padding) {
        try {
             ...
             */
            kernelParameters = Pointer.to(Pointer.to(new long[]{dx.getDataLength()}), Pointer.to(dy.getGpuData()), Pointer.to(new int[]{dy.getShape()[0]}), Pointer.to(new int[]{C}), Pointer.to(new int[]{H}), Pointer.to(new int[]{W}), Pointer.to(new int[]{H * W}), Pointer.to(new int[]{oHeight}), Pointer.to(new int[]{oWidth}), Pointer.to(new int[]{oHeight * oWidth}), Pointer.to(new int[]{padding[2]}), Pointer.to(new int[]{padding[0]}), Pointer.to(dx.getGpuData()));
            cuLaunchKernel(gradFunction2d, this.CAFFE_GET_BLOCKS(dx.getDataLength()), 1, 1,      // Grid dimension
                    CAFFE_CUDA_NUM_THREADS, 1, 1,      // Block dimension
                    0, null,               // Shared memory size and stream
                    kernelParameters, null // Kernel- and extra parameters
            );
    ...
    public void padding3d(Tensor x, Tensor y, int xd, int[] padding, float val) {
        try {
            ...
            int oHeight = H + padding[2] + padding[3];
            int oWidth = W + padding[0] + padding[1];
            if (y.getShape()[1] != oDepth * C || y.getShape()[2] != oHeight || y.getShape()[3] != oWidth) {
                throw new RuntimeException("the output tensor shape is not same as padded shape.");
            }
            /**
             * 设置入参
             ...
             */
            kernelParameters = Pointer.to(Pointer.to(new long[]{y.getDataLength()}), Pointer.to(x.getGpuData()), Pointer.to(new int[]{x.getShape()[0]}), Pointer.to(new int[]{C}), Pointer.to(new int[]{D}), Pointer.to(new int[]{H}), Pointer.to(new int[]{W}), Pointer.to(new int[]{D * H * W}), Pointer.to(new int[]{H * W}), Pointer.to(new int[]{oDepth}), Pointer.to(new int[]{oHeight}), Pointer.to(new int[]{oWidth}), Pointer.to(new int[]{oDepth * oHeight * oWidth}), Pointer.to(new int[]{oHeight * oWidth}), Pointer.to(new int[]{padding[4]}), Pointer.to(new int[]{padding[2]}), Pointer.to(new int[]{padding[0]}), Pointer.to(new float[]{val}), Pointer.to(y.getGpuData()));
            cuLaunchKernel(function, this.CAFFE_GET_BLOCKS(y.getDataLength()), 1, 1,      // Grid dimension
                    CAFFE_CUDA_NUM_THREADS, 1, 1,      // Block dimension
                    0, null,               // Shared memory size and stream
                    kernelParameters, null // Kernel- and extra parameters
            );
    ...
    public void padding3dGrad(Tensor dy, Tensor dx, int xd, int[] padding) {
        try {
             ...
             */
            kernelParameters = Pointer.to(Pointer.to(new long[]{dx.getDataLength()}), Pointer.to(dy.getGpuData()), Pointer.to(new int[]{dy.getShape()[0]}), Pointer.to(new int[]{C}), Pointer.to(new int[]{D}), Pointer.to(new int[]{H}), Pointer.to(new int[]{W}), Pointer.to(new int[]{D * H * W}), Pointer.to(new int[]{H * W}), Pointer.to(new int[]{oDepth}), Pointer.to(new int[]{oHeight}), Pointer.to(new int[]{oWidth}), Pointer.to(new int[]{oDepth * oHeight * oWidth}), Pointer.to(new int[]{oHeight * oWidth}), Pointer.to(new int[]{padding[4]}), Pointer.to(new int[]{padding[2]}), Pointer.to(new int[]{padding[0]}), Pointer.to(dx.getGpuData()));
            cuLaunchKernel(gradFunction, this.CAFFE_GET_BLOCKS(dx.getDataLength()), 1, 1,      // Grid dimension
                    CAFFE_CUDA_NUM_THREADS, 1, 1,      // Block dimension
                    0, null,               // Shared memory size and stream
                    kernelParameters, null // Kernel- and extra parameters
            );
